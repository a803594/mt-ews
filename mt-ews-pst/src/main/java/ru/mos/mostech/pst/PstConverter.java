...
import ru.mos.mostech.pst.mail.EmlStore;
...
/**
 * Преобразует файл Outlook OST/PST в формат MBox или EML.
 *
 */
public class PstConverter {
    ...
    /**
     * Название пользовательского заголовка, добавляемого к каждому преобразованному сообщению, для удобного
     * отслеживания исходного сообщения из файла OST/PST.
     */
    ...
    /**
     * Извлекает значение заголовка ID описателя Outlook из каждого ранее
     * конвертированного сообщения этим конвертером. Этот метод можно использовать для проверки, 
     * была ли конвертация файла PST выполнена как ожидалось, позволяя сравнивать
     * возвращаемый набор идентификаторов с теми, которые найдены в оригинальном PST.
     *
     * @param directory Директория, в которой нужно найти сообщения.
     * @param format Формат сообщения (MBOX или EML).
     * @param encoding Кодировка сообщения.
     * @return Множество со всеми найденными идентификаторами сообщений.
     ...
     * Преобразует файл Outlook OST/PST в формат MBox или EML.
     *
     * @param inputFile Входной PST файл.
     * @param outputDirectory Директория, куда извлекаются и сохраняются
     * электронные сообщения.
     * @param format Формат вывода (MBOX или EML).
     * @param encoding Кодировка символов, используемая для символьных данных.
     * @return количество успешно преобразованных сообщений и длительность
     ...
     * Преобразует файл Outlook OST/PST в формат MBox или EML.
     *
     * @param pstFile Входной PST файл.
     * @param outputDirectory Директория, куда извлекаются и сохраняются
     * электронные сообщения.
     * @param format Формат вывода (MBOX или EML).
     * @param encoding Кодировка символов, используемая для символов данных.
    ...
    /**
     * Рекурсивно проходит все PSTFolders, начиная с корневого PSTFolder,
     * и извлекает все электронные сообщения в javax.mail.Folder.
     *
     * @param pstFolder
     * @param mailFolder
     * @param path
    ...
    /**
     * Преобразует PSTMessage в MimeMessage.
     *
     * @param message Объект PSTMessage.
     * @param charset
     * @return Новый объект MimeMessage.
     * @throws MessagingException
     * @throws IOException
     * @throws PSTException
     * @see
     * <a href="https://www.independentsoft.de/jpst/tutorial/exporttomimemessages.html">Экспорт
     * в MIME сообщения (.eml файлы)</a>
     */
    ...
    /**
     * Извлекает содержимое PST-вложения.
     *
     * @param attachment
     * @return Массива байтов с содержимым вложения.
     * @throws PSTException Если невозможно получить поток ввода вложения.
     * @throws IOException Если произошла ошибка при чтении байтов из потока ввода.
     */
