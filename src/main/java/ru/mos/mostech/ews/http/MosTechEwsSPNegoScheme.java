...
public class MosTechEwsSPNegoScheme extends SPNegoScheme {
	...
	protected byte[] generateGSSToken(final byte[] input, final Oid oid, final String authServer,
		...
		log.debug("KerberosHelper.initSecurityContext " + protocol + '@' + authServer + ' ' + input.length
				+ " bytes token");
	...
	protected Object internalGenerateGSSToken(final byte[] input, final Oid oid, final String authServer,
