...
public class AutoDiscoveryFacade {
	...
	public static void main(String[] args) {
		Optional<ResolveEwsResults> resolveEws = resolveEws(
				ResolveEwsParams.builder().email("***REMOVED***").password("***REMOVED***").build());
	...
	public static Optional<ResolveEwsResults> resolveEws(ResolveEwsParams params) {
		...
		List<AutoDiscoveryRequestParams> requests = List.of(getParams(params, result, true, true, false),
				getParams(params, result, true, false, false), getParams(params, result, true, false, true),

				getParams(params, result, false, true, false), getParams(params, result, false, false, false),
	...
	private static AutoDiscoveryRequestParams getParams(ResolveEwsParams params, DnsSrvLookup.LookupResult result,
			boolean isSecure, boolean forceUseEmail, boolean forceHQ) {
