...
public class EwsExchangeSession extends ExchangeSession {
    ...
    protected class Event extends ExchangeSession.Event {
        ...
        protected List<FieldUpdate> buildFieldUpdates(VCalendar vCalendar, VObject vEvent, boolean isMozDismiss) throws MosTechEwsException {
    ...
    protected void loadVtimezone() {
        ...
        try {
            ...
            CreateItemMethod createItemMethod = new CreateItemMethod(MessageDisposition.SaveOnly, SendMeetingInvitations.SendToNone, getFolderId("mt-ews-temp"), item);
            executeMethod(createItemMethod);
