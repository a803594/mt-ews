...
public class O365Authenticator implements ExchangeAuthenticator {
    ...
    public void authenticate() throws IOException {
        ...
        String redirectUri = Settings.getProperty("mt.ews.oauth.redirectUri", Settings.O365_LOGIN_URL+"common/oauth2/nativeclient");
                ...
                if (federationRedirectUrl != null && !federationRedirectUrl.isEmpty()) {
                    ...
                    if (location == null || !location.toString().startsWith(redirectUri)) {
                        ...
                        if (config.optJSONArray("arrScopes") != null || config.optJSONArray("urlPostRedirect") != null) {
                            ...
                            throw new MosTechEwsAuthenticationException("LOG_MESSAGE", "Authentication failed, unknown error: " + config);
                        }
                    }
                    ...
                    if (query.contains("code=")) {
                        ...
                        throw new MosTechEwsAuthenticationException("LOG_MESSAGE", "Authentication failed, unknown error: " + query);
                    }
                }
            }
