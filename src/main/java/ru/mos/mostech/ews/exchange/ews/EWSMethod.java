            ...
            public void writeTo(OutputStream outputStream) throws IOException {
                ...
                if (content.length < CHUNK_LENGTH) {
                    ...
                    while (i < content.length) {
                        ...
                        if (!firstPass) {
                            MosTechEwsTray.debug(new BundleMessage("LOG_UPLOAD_PROGRESS", String.valueOf((i + length) / 1024), (i + length) * 100 / content.length));
            ...
            inputStream = new FilterInputStream(inputStream) {
                ...
                public int read(byte[] buffer, int offset, int length) throws IOException {
                    ...
                    if (totalCount - lastLogCount > 1024 * 128) {
                        MosTechEwsTray.debug(new BundleMessage("LOG_DOWNLOAD_PROGRESS", String.valueOf(totalCount / 1024), EWSMethod.this.getURI()));
                        MosTechEwsTray.switchIcon();
